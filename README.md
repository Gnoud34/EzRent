...
To ensure code consistency and prevent conflicts, all members must adhere to the following workflow:
...
3. **Push and Create Pull Request (PR):** Push your branch to GitHub and create a PR for peer review before final merging into main.
...
*Note: Always verify your .gitignore file to ensure node\_modules is not uploaded to GitHub.*
